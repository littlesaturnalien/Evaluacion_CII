...
In Evaluacion_CII-labels_en.properties:
Evaluacion_CII=My application
Evaluacion_CII[description]=My application does this and that

In Evaluacion_CII-messages_en.properties:
